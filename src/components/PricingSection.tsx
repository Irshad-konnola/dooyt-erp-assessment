...
export default function PricingSection({ initialPlans }: { initialPlans: Plan[] }) {
  ...
  return (
    <section id="pricing" className="py-6 bg-[#FAFAFA] font-sans">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Pricing Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-8xl mx-auto items-center mb-20">
          {plans.map((plan) => {
              ...
              >
                ...
                {plan.isPopular ? (
                  <div className="bg-[#F26419] rounded-[32px] pt-4 px-2 pb-2 shadow-2xl">
                    ...
                    <div className="bg-[#FFF9F5] rounded-[24px] p-4 h-full">
                      <div className="mb-4">
                        <h3 className="text-xl font-bold text-[#111] flex items-center gap-2">
                          {plan.name} <Zap className="w-3 h-3 text-[#F26419] fill-[#F26419]" />
                        </h3>
                        <p className="text-zinc-500 text-sm mt-2">{plan.tagline}</p>
                      </div>
                      <div className="mb-4">
                        <span className="text-3xl font-black text-[#111]">₹{price.toLocaleString()}</span>
